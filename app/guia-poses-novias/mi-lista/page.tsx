...
export default function Page() {
  const items = getPoses().map((p) => ({ n: p.n, slug: p.slug, guide: p.guide, star: p.star, h1: p.h1, img: p.img, tell: p.tellPhotographer, tip: p.quickAnswer.split('.')[0] + '.', altText: p.altText }));
