          ...
          <div className={styles.section}>
            ...
            <div className={styles.activityTable}>
              <div className={styles.tableRow}>
                <div className={styles.tableCell}>✅ Nuevo servicio creado</div>
                <div className={styles.tableCell}>Hace 2 horas</div>
              </div>
              <div className={styles.tableRow}>
                <div className={styles.tableCell}>📩 Cliente nuevo registrado</div>
                <div className={styles.tableCell}>Hace 5 horas</div>
              </div>
              <div className={styles.tableRow}>
                <div className={styles.tableCell}>💳 Pago recibido</div>
                <div className={styles.tableCell}>Hace 1 día</div>
              </div>
              <div className={styles.tableRow}>
                <div className={styles.tableCell}>⚙️ Sistema actualizado</div>
