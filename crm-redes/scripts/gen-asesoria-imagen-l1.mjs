...
import { M, LOOK_FORMAL, LOOK_SOCIAL, LOOK_EDITORIAL, SET_STUDIO, SET_WINDOW, SET_VANITY, SET_DESK, STYLE_BASE, SHOT_WIDE, SINGLE, DIPTYCH } from './asesoria-imagen-style.mjs';
...
const jobs = [
  ...
  },
  {
    id: 'l1-3',
    ...SINGLE(
      `${LOOK_SOCIAL}, de pie mirando su propio reflejo de cuerpo completo con la mano en la barbilla, expresión reflexiva y evaluadora, ${SET_VANITY}`,
      SHOT_WIDE,
    ),
  },
  {
